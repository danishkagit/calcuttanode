...
const products = [
  { name: 'Website Template Pack', slug: 'website-template-pack', category: 'Templates', price: 499, description: '5 ready-to-use HTML/CSS website templates for portfolio, business, landing page, blog, and coming soon.', fileUrl: '/uploads/products/website-template-pack.zip', features: ['5 responsive templates', 'HTML5 + CSS3', 'Easy to customize', 'Documentation included', 'Free updates'] },
  { name: 'SEO Audit Checklist', slug: 'seo-audit-checklist', category: 'Guides', price: 199, description: 'A comprehensive 50-point SEO audit checklist covering on-page, off-page, technical SEO, and local SEO.', fileUrl: '/uploads/products/seo-audit-checklist.pdf', features: ['50-point checklist', 'On-page & off-page SEO', 'Technical SEO guide', 'Local SEO section', 'Printable PDF'] },
  { name: 'Social Media Content Calendar', slug: 'social-media-calendar', category: 'Templates', price: 299, description: 'A 30-day social media content calendar template for Instagram, Facebook, LinkedIn, and Twitter.', fileUrl: '/uploads/products/social-media-calendar.xlsx', features: ['30-day calendar', 'Multi-platform support', 'Post idea prompts', 'Google Sheets format', 'Editable templates'] },
  { name: 'PC Optimization Script Bundle', slug: 'pc-optimization-scripts', category: 'Tools', price: 299, description: 'PowerShell and batch scripts to clean temp files, optimize startup, defrag drives, check disk health, and more.', fileUrl: '/uploads/products/pc-optimization-scripts.zip', features: ['10+ automation scripts', 'Clean temp files', 'Startup optimization', 'Disk health checks', 'Safe to run'] },
