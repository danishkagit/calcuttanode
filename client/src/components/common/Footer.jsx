    ...
    <footer className="relative glass mt-auto overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        <motion.div className="sm:col-span-2 md:col-span-1" {...fadeUp}>
          ...
          <p className="text-text-muted text-sm leading-relaxed">AI-Powered Digital Growth Agency based in Kolkata, India. Serving clients worldwide since 2023 at calcuttanode.ai.</p>
            ...
            {[
              ...
              <motion.a key={i} whileHover={{ scale: 1.1, y: -2 }} href={s.href} target="_blank" rel="noopener noreferrer"
                className={`w-8 h-8 rounded-lg border flex items-center justify-center transition-all duration-200 ${
                  i === 0 ? 'bg-white/5 border-electric-violet/20 text-text-muted hover:text-neon-cyan hover:border-neon-cyan/40' : 'bg-white/5 border-electric-violet/20 text-text-muted hover:text-neon-cyan hover:border-neon-cyan/40'
                }`}
              >
