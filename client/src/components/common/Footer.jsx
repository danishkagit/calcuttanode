    ...
    <footer className="relative bg-surface/60 border-t border-electric-violet/20 mt-auto overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        <motion.div className="sm:col-span-2 md:col-span-1" {...fadeUp}>
          ...
          <p className="text-text-muted text-sm leading-relaxed">IT Services & Digital Growth Agency based in Champdani, Hooghly, West Bengal. Serving businesses since 2023.</p>
      ...
      <div className="relative border-t border-electric-violet/10 py-4 text-center">
        ...
        <p className="text-text-muted text-xs">&copy; {new Date().getFullYear()} Calcutta Node. All rights reserved. | Champdani, Hooghly, West Bengal</p>
      </div>
    </footer>
  );
}
