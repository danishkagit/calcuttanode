  ...
  return (
    <div>
      ...
      <motion.section className="py-16 px-4 text-center" {...fadeUp}>
        ...
        <div className="flex gap-4 justify-center flex-wrap">
          <a href="/work" className="bg-brand-gradient text-white px-8 py-3 rounded-xl font-medium transition-all duration-200 hover:shadow-lg hover:shadow-neon-cyan/20 hover:scale-105 active:scale-95">
            Our Work
          </a>
          <a href="/pricing" className="border border-neon-cyan text-neon-cyan px-8 py-3 rounded-xl font-medium transition-all duration-200 hover:bg-neon-cyan/10">
            View Services
          </a>
        </div>
      </motion.section>
